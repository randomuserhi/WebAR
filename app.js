...
app.scene.add(light);
const neuronPlane = new PlaneTrack(app, neuron.markers);
const slpPlane = new PlaneTrack(app, slp.markers);
const backpropPlane = new PlaneTrack(app, backprop.markers);
const flappyPlane = new PlaneTrack(app, flappy.markers);
